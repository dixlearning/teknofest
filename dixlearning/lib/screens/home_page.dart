...
class _LoginPageState extends State<LoginPage> {
  ...
  void LoadUser() async {
    if (Supabase.instance.client.auth.currentSession != null) {
      Question? matchQuestion = await _gameManager.getNextGame();
      if (matchQuestion == null) {
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => Dashboard()));
      } else {
        Navigator.pushNamed(context, matchQuestion.Route!);
      }
    } else {
      setState(() {
        _isLoading = true;
                    ...
                    children: [
                        ...
                        child: Opacity(
                          ...
                          child: Container(
                            ...
                            margin: EdgeInsets.only(
                                top: height *
                                    0.2), // Logo biraz aşağı kaydırıldı
                      ...
                      Padding(
                        padding: EdgeInsets.only(
                            top: height *
                                0.25), // İçerikler logonun altında hizalanır
                        child: Center(
                          child: Column(
                            children: [
                              Container(
